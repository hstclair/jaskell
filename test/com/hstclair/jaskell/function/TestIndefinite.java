...
//
//        Expression<Long> orElse = indefinite.orElse((Expression<Long>) () -> notExpected);
//
...
//        Expression<Indefinite<Object>> o = Indefinite.EMPTY.orElse(Indefinite.EMPTY);
//
//        assertFalse(o.evaluate().isPresent());
//    }
//
